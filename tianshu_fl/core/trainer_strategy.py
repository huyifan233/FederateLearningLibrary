...
class TrainerStrategy(object):
    ...
    def start(self):
        if self.work_mode == WorkModeStrategy.WORKMODE_STANDALONE:
            self.trainer_executor_pool.submit(self._train_standalone_exec)
        else:
    ...
    def _train_in_distillation(self, data, job, train_model, alpha, job_models_path, fed_step):
        pass
    ...
    def _train_standalone_exec(self):
        # start train
        while True:
    ...
    def _trainer_standalone_exec_distillation(self):
